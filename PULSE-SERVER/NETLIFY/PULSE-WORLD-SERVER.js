...
navigator.serviceWorker.register('../DriftServerCoordinator.js');

// ============================================================================
// UNIVERSAL TIMESTAMP / ADMIN / DB (shadow-first)
// ============================================================================
...
import { AiOvermindPrime } from "../../PULSE-MULTIVERSE/PULSE-UNIVERSE/PULSE-GALAXY/PULSE-WORLD/PULSE-PHYSICS/X-PULSE-X/PULSE-WORLD-ALDWYN.js";
import {createPulseCastle as PulseWorldCastle} from "../../PULSE-MULTIVERSE/PULSE-UNIVERSE/PULSE-GALAXY/PULSE-WORLD/PULSE-PHYSICS/PULSE-EXPANSION/PULSE-EXPANSION-CASTLE.js";
import {createPulseMesh as PulseWorldMesh} from "../../PULSE-MULTIVERSE/PULSE-UNIVERSE/PULSE-GALAXY/PULSE-WORLD/PULSE-PHYSICS/PULSE-EXPANSION/PULSE-EXPANSION-MESH.js";
import { pulsarBus, updateWorldState as pulsarUpdateWorldState, getWorldState as pulsarGetWorldState, registerSatellitePreSignal, decaySatellitePreSignal, updateSatelliteWindowFromEphemeris,
  decideRoute as pulsarDecideRoute, dispatchPulse as pulsarDispatchPulse, applyAdaptiveFeedback as pulsarApplyAdaptiveFeedback} from "../../PULSE-MULTIVERSE/PULSE-UNIVERSE/PULSE-UNIVERSAL-PULSAR.js";
import { PulseForward as createForwardEngine} from "../../PULSE-MULTIVERSE/PULSE-UNIVERSE/PULSE-GALAXY/PULSE-WORLD/PULSE-PHYSICS/PULSE-ENGINE/PulseEngineForwardProcess-v31.js";
import { PulseBackward as createBackwardEngine} from "../../PULSE-MULTIVERSE/PULSE-UNIVERSE/PULSE-GALAXY/PULSE-WORLD/PULSE-PHYSICS/PULSE-ENGINE/PulseEngineBackwardProcess-v31.js";
import { handler as prewarm } from "./PULSEWORLDNET-PREWARM.js";
import {createPulseRouter} from "../../PULSE-MULTIVERSE/PULSE-UNIVERSE/PULSE-GALAXY/PULSE-WORLD/PULSE-PHYSICS/X-PULSE-X/PULSE-WORLD-INTERNET-ROUTER.js";
...
export async function route(channel, packet) {
  const meaning = await PulseRealm.PulseUnderstanding.handle({ channel, ...packet });
...
// ============================================================================
// TOUCH ORGAN (v30) — ONE-BAND SKIN SNAPSHOT
// ============================================================================
